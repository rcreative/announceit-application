...
Rails::Initializer.run(:process, AnnounceConfiguration.new) do |config|
  ...
  config.gem "xaviershay-db2s3", :lib => "db2s3",
    :source => "http://gems.github.com"
  ...
  config.action_controller.session = {
    :session_key => '_announce_session',
    :secret      => '3c8893212b480705b27c5711c66155be87468503198e0773044cd7145fe904fdbac0911b0cb76b781cb7ad276f7250775a4aa969e2a1263f4b5822d1d01ab81b'
  }
